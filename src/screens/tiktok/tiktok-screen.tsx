...
const DEMO_STORYBOARD: Scene[] = [
  {
    sceneNumber: 1,
    angle: 'Top Down',
    action: 'AeroGlow LED Face Mask laid flat on white linen as a knit-sleeved hand reaches gently into frame from below',
    image_prompt: 'overhead flat lay, AeroGlow LED Face Mask placed on white linen, hand gently reaches into frame from bottom, aesthetic product photography, feminine hand wearing cream knit oversized sleeve, soft natural window light from left side, white linen cloth background, ASMR close-up macro style, minimal clean desk setup, consistent warm neutral tone, shot on iPhone vertical, no text no watermark, ultra realistic, 8k',
    voiceover_text: 'Pernahkah anda terkejut bila tengok harga rawatan spa yang mencecah ratusan ringgit?',
  },
  {
    sceneNumber: 2,
    angle: 'Close Up',
    action: 'Hand holds the AeroGlow LED Face Mask upright facing camera, fingers wrapped naturally around the product',
    image_prompt: 'hand holds AeroGlow LED Face Mask upright facing camera, front angle close up, fingers wrapped around product naturally, aesthetic product photography, feminine hand wearing cream knit oversized sleeve, soft natural window light from left side, white linen cloth background, ASMR close-up macro style, minimal clean desk setup, consistent warm neutral tone, shot on iPhone vertical, no text no watermark, ultra realistic, 8k',
    voiceover_text: 'Tapi kini ada penyelesaian yang lebih berpatutan — mask LED AeroGlow yang canggih.',
  },
  {
    sceneNumber: 3,
    angle: 'Medium Shot',
    action: 'Hand slowly rotates AeroGlow LED Face Mask to reveal the side profile with brand label clearly visible',
    image_prompt: 'hand slowly rotates AeroGlow LED Face Mask to show side profile, 45 degree angle, product label visible, aesthetic product photography, feminine hand wearing cream knit oversized sleeve, soft natural window light from left side, white linen cloth background, ASMR close-up macro style, minimal clean desk setup, consistent warm neutral tone, shot on iPhone vertical, no text no watermark, ultra realistic, 8k',
  ...
  },
  {
    ...
    action: 'Extreme macro close-up of fingertip pressing the power button on the AeroGlow LED Face Mask',
    image_prompt: 'extreme close up macro shot, hand demonstrates main product feature or button on AeroGlow LED Face Mask, fingertip detail visible, aesthetic product photography, feminine hand wearing cream knit oversized sleeve, soft natural window light from left side, white linen cloth background, ASMR close-up macro style, minimal clean desk setup, consistent warm neutral tone, shot on iPhone vertical, no text no watermark, ultra realistic, 8k',
    voiceover_text: 'Hanya 20 minit, tiga kali seminggu — dan kulit anda akan berubah dalam masa dua minggu sahaja!',
  },
  {
    sceneNumber: 5,
    angle: 'POV',
    action: 'AeroGlow LED Face Mask set beside a small ceramic coffee cup and succulent plant, hand rests lightly on top of the product',
    image_prompt: 'AeroGlow LED Face Mask placed beside aesthetic props — small plant or ceramic coffee cup, hand lightly touches product, lifestyle context, aesthetic product photography, feminine hand wearing cream knit oversized sleeve, soft natural window light from left side, white linen cloth background, ASMR close-up macro style, minimal clean desk setup, consistent warm neutral tone, shot on iPhone vertical, no text no watermark, ultra realistic, 8k',
    voiceover_text: 'Lebih 50,000 pelanggan sudah membuktikan — kolagen meningkat dan kulit semakin cerah dan bersinar!',
  },
  {
    sceneNumber: 6,
    angle: 'Wide Shot',
    action: 'AeroGlow LED Face Mask resting next to its premium box, hand lifts the product gently out in an unboxing reveal',
    image_prompt: 'AeroGlow LED Face Mask inside or next to its packaging or box, hand lifts product out gently, unboxing moment, aesthetic product photography, feminine hand wearing cream knit oversized sleeve, soft natural window light from left side, white linen cloth background, ASMR close-up macro style, minimal clean desk setup, consistent warm neutral tone, shot on iPhone vertical, no text no watermark, ultra realistic, 8k',
